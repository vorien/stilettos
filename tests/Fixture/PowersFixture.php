...
class PowersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lock_level_requirement' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'type' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'duration' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'target' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'has_range' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'use_end' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'sort_order' => 1,
            'lock_level_requirement' => 1,
            'type' => 'Lorem ipsum dolor sit amet',
            'duration' => 'Lorem ipsum dolor sit amet',
            'target' => 'Lorem ipsum dolor sit amet',
            'has_range' => 'Lorem ipsum dolor sit amet',
            'use_end' => 'Lorem ipsum dolor sit amet',
            'maneuver_id' => 1,
            'active' => 1,
